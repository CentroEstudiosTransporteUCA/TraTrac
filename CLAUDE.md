...
| Run the CLI | `uv run tratrac VIDEO --out PATH (--meters-per-pixel M \| --drone-model KEY) [--detector yolov8_visdrone\|rt_detr] [--conf 0.25] [--start MM:SS] [--end MM:SS] [--timestep-precision SECONDS] [--force]` |
