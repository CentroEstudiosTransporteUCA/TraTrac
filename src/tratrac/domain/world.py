...
``src/tratrac/application/WORLD_PROJECTION.md``): a set of points whose pixel position *and* real-world ground
...
(``src/tratrac/application/EXCLUSION_ZONES.md``): ``reference_frame = 0`` for a static camera / single
