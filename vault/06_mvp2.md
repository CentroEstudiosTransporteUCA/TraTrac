...
> roadmap reconciliation in `00_system_overview.md`. This is the **load-bearing gap**: SSAM
> positions remain image-space pixels until world projection lands, so metric analytics are not
> yet scientifically valid.
